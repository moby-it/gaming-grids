  ...
  <header>
    ...
    <div>
      <svg width="40px" height="40px" stroke-width="1.2" viewBox="0 0 24 24" fill="none"
        ...
        <path d="M15 21H9V12.6C9 12.2686 9.26863 12 9.6 12H14.4C14.7314 12 15 12.2686 15 12.6V21Z" stroke="#FFFFFF"
      ...
      <svg width="40px" height="40px" stroke-width="1.7" viewBox="0 0 24 24" fill="none"
        ...
        <path d="M9 9C9 5.49997 14.5 5.5 14.5 9C14.5 11.5 12 10.9999 12 13.9999" stroke="#FFFFFF" stroke-width="1.7"
          stroke-linecap="round" stroke-linejoin="round"></path>
        <path d="M12 18.01L12.01 17.9989" stroke="#FFFFFF" stroke-width="1.7" stroke-linecap="round"
          stroke-linejoin="round"></path>
      </svg>
      <Button @clicked="console.log('5')">Sign In</Button>
    </div>
  </header>
</template>
